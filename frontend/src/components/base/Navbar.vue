    ...
    <nav v-else class="flex justify-between dark:bg-primary-100 dark:text-white items-center">
        ...
        <div class="flex gap-5 items-center">
            ...
            <div class="cursor-pointer relative">
              <RouterLink :to="{ name: 'wishlist' }" :class="{ active: isActive('wishlist') }">
            ...
            <div class="cursor-pointer relative">
              <RouterLink :to="{ name: 'cart' }" :class="{ active: isActive('cart') }">
        ...
        <div @click="toggleMenuMobile" class="sm:hidden cursor-pointer flex  items-center">
